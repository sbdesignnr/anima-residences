            ...
            <div>
              ...
              {state === "sent" ? (
                <div className="ct-rise mt-10 flex flex-col items-start gap-4 border p-10" style={{ borderColor: "rgba(182,154,120,0.4)", background: "rgba(182,154,120,0.06)" }}>
                  ...
                  <p style={{ fontFamily: "var(--font-dm-sans)", fontSize: "13px", fontWeight: 300, lineHeight: 1.9, color: "rgba(28,28,26,0.7)" }}>
  ...
  return (
    ...
    >
      ...
      <dd
        ...
        style={{ fontFamily: "var(--font-dm-sans)", fontSize: "13px", fontWeight: 300, lineHeight: 1.85, color: "rgba(28,28,26,0.82)" }}
      >
        {children}
      </dd>
    </div>
