...
export const POIS: Poi[] = [
  // Príroda & šport
  { name: "Mestský park Sihoť", cat: "priroda", slug: "sihot", lat: 48.3192, lng: 18.08559, dir: 354, walk: 25, bike: 8, car: 6, note: "Zeleň a promenáda hneď za rohom — najbližší kus prírody.", maps: "Mestský park Sihoť, Nitra" },
  { name: "Nábrežie rieky Nitra", cat: "priroda", slug: "nabrezie", lat: 48.31607, lng: 18.09744, dir: 31, walk: 24, bike: 7, car: 6, note: "Súvislý cyklochodník pozdĺž vody až do centra.", maps: "Nábrežie rieky Nitra" },
  { name: "Zobor — vyhliadka", cat: "priroda", slug: "zobor", lat: 48.34252, lng: 18.10485, dir: 17, walk: 70, bike: 22, car: 14, note: "Lesné chodníky a výhľad na celú Nitru nad mestom.", maps: "Zoborská vyhliadka Pyramída, Nitra" },
  ...
  { name: "OC Mlyny", cat: "nakupy", slug: "mlyny", lat: 48.30696, lng: 18.08649, dir: 335, walk: 4, bike: 2, car: 2, note: "Najväčšie nákupné centrum mesta pod jednou strechou.", maps: "OC Mlyny Nitra" },
